...
export const metadata: Metadata = {
  ...
  description:
    "پلتفرم رسمی مدیریت آب و انرژی خراسان رضوی - دسترسی real-time به آمار و گزارش‌های تخصصی، داشبورد تحلیلی پیشرفته، پایش لحظه‌ای مصرف و ماشین‌حساب‌های هوشمند انرژی. اکنون وارد شوید و منابع را بهینه کنید!",
  keywords: [
    "آب خراسان رضوی",
    "انرژی خراسان رضوی",
    "برق مشهد",
