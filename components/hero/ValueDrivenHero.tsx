  ...
  return (
    <section className="relative min-h-screen overflow-hidden bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950">
      ...
      >
        ...
        >
          <div className="flex items-center gap-2 bg-white/15 backdrop-blur-xl border border-white/25 rounded-full px-4 py-2">
        ...
        <div className="text-center mb-16">
          ...
          >
            ...
            <AnimatePresence mode="wait">
              ...
              >
                <p className="mb-3">
                  <span className="text-red-400 font-bold">مشکل:</span> <span className="text-gray-100">{currentResource.problem}</span>
                </p>
                <p className="mb-3">
                  <span className="text-green-400 font-bold">راه‌حل:</span> <span className="text-gray-100">{currentResource.solution}</span>
                </p>
                <p>
                  <span className="text-cyan-400 font-bold">تأثیر:</span> <span className="text-gray-100">{currentResource.impact}</span>
                </p>
              </motion.div>
            </AnimatePresence>
          </motion.div>
          ...
          {resources.map((resource, index) => {
            ...
            return (
              ...
              >
                <motion.div
                  className={`
                    relative h-full bg-white/15 backdrop-blur-xl rounded-2xl p-6
                    border-2 transition-all duration-300
                    ${isActive || isHovered ? 'border-white/40 bg-white/20' : 'border-white/25'}
                  `}
                  animate={{
                    boxShadow: isActive
                ...
                >
                  ...
                  <div className="relative z-10">
                    ...
                    <motion.div
                      ...
                      className="mt-4 pt-4 border-t border-white/25"
                    >
            ...
            {governancePillars.map((pillar, idx) => {
              ...
              return (
                <motion.div
                  ...
                  className="relative bg-white/15 backdrop-blur-xl border border-white/25 rounded-xl p-5 hover:bg-white/20 hover:border-white/30 transition-all group overflow-hidden"
                >
                  ...
                  <div className="relative z-10">
                    ...
                    <p className="text-sm text-gray-200 mb-2">{pillar.description}</p>
        ...
        >
          <div className="flex items-center gap-2">
            ...
            <span className="text-white">امنیت تضمین شده</span>
          </div>
          <div className="flex items-center gap-2">
            <CheckCircle2 className="w-4 h-4 text-blue-400" />
            <span className="text-white">استانداردهای بین‌المللی</span>
          </div>
          <div className="flex items-center gap-2">
            <CheckCircle2 className="w-4 h-4 text-yellow-400" />
            <span className="text-white">پایش لحظه‌ای</span>
          </div>
          <div className="flex items-center gap-2">
            <CheckCircle2 className="w-4 h-4 text-purple-400" />
            <span className="text-white">تحلیل هوشمند</span>
          </div>
        </motion.div>
      </motion.div>
      ...
      >
        ...
        >
          <span className="text-gray-300 text-xs font-medium">ادامه مطلب</span>
